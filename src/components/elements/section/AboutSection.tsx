  ...
  const facts: Facts[] = [
    {
      ...
      title: "Puzzles",
      description:
        "I've assembled over 200 puzzles, ranging from 2,500 to 5,000 pieces; My Top images are the World Map 1864, and Van Gogh's painting Starry Night Over the Rhône ",
      bg: "#40E0D0",
    },
    {
    ...
    },
    {
      ...
      title: "Dancing",
      description:
        "I danced professionally for 13 years and won the European Cup in the 14-16 y.o. category",
      bg: "#FF4081",
    },
    {
      ...
      title: "Travel Guide",
      description:
        "I once worked as a tour guide in Turkey, sharing culture and stories with travelers from around the world",
      bg: "#87CEEB",
    },
    {
      ...
      title: "Vegan",
      description:
        "I don't eat meat, sugar, or drink alcohol — I believe in conscious and balanced living",
      bg: "#4CAF50",
    },
    {
      ...
      title: "Chess",
      description:
        " I love chess —Played for school and university in city competitions",
  ...
  return (
    <div className="flex flex-col w-full h-full items-center justify-start p-2 sm:overflow-y-auto max-sm:space-y-3 max-sm:min-h-dvh">
      <div className="flex flex-col items-start space-y-2 w-full">
        <h1 className="text-4xl font-bold text-white max-sm:hidden">
          Mouhammad DIALLO
        </h1>
        <h1 className="text-2xl font-bold text-[#ED816C] self-end sm:hidden">
          A propes de Moi
        </h1>
        <p className="text-2xl font-semibold text-[#CE9178] max-sm:hidden ">
          Développeur Web Full Stack
        </p>
        <p ref={textRef} className="text-xl text-white max-sm:text-center">
          To me, programming is like solving a complex puzzle: at first, it may
          look chaotic, but with patience and attention to detail, each piece
          clicks into place. It’s a creative process rooted in logic — where you
          build something meaningful from nothing. I find inspiration in walks
          through the forest and a good cup of coffee. Yoga and puzzles help me
          stay balanced and focused.
        </p>
      </div>
      <div
        className={`${zoom ? "flex flex-wrap justify-center max-w-190 gap-3" : "flex flex-wrap justify-center max-w-235 gap-3"}`}
      >
        {facts.map((item) => {
          return (
            <div
