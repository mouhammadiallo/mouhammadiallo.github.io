      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center space-x-3 max-sm:hidden">
          ...
          <ul className="flex items-center justify-between space-x-5 ">
            <li className="hover:text-[#979797] cursor-pointer">Bienvenue</li>
            <li className="hover:text-[#979797] cursor-pointer">Edition</li>
            <li className="hover:text-[#979797] cursor-pointer">Affichage</li>
            <li className="hover:text-[#979797] cursor-pointer">Terminal</li>
            <li className="hover:text-[#979797] cursor-pointer">Aide</li>
          </ul>
        </div>
        <span>Mouhammad DIALLO - Visual Studio Code</span>
      ...
      <div className="flex w-full h-full">
        ...
        <div className="flex flex-col w-20 justify-between items-center bg-[#252526] max-sm:hidden">
          <div className="flex flex-col w-full">
            <div
              className="hover:bg-[#333333] active:bg-[#333333] hover:cursor-pointer"
              title="Voir mes projets"
              onClick={() => setActiveTab("projects")}
            >
              <img src={IconFile} alt="Icon File" className="w-full" />
            </div>
            <div
              className="hover:bg-[#333333] active:bg-[#333333] hover:cursor-pointer"
            ...
            >
              <img src={IconCode} alt="Icon Code" className="w-full" />
            </div>
          </div>
          <div className="flex flex-col w-full">
            <a
            ...
            >
              <img src={IconGit} alt="Icon Git" className="w-full" />
            </a>
            <a
              className="hover:bg-[#333333] active:bg-[#333333]"
            ...
            >
              <img src={IconLinkEdin} alt="Icon LinkEdin" className="w-full" />
            </a>
            <div
              className="hover:bg-[#333333] active:bg-[#333333] hover:cursor-pointer"
            ...
            >
              <img src={IconLetter} alt="Icon contact me" className="w-full" />
            </div>
            <a
              className="hover:bg-[#333333] active:bg-[#333333]"
              ...
              title="Voir mon CV"
            >
              <img src={IconProfil} alt="Icon my CV" className="w-full" />
            </a>
          </div>
        </div>
        {/* SideNav */}
        <div className="flex flex-col w-2xs justify-start items-start p-2 text-[#D4D4D4] max-sm:hidden">
          ...
          <span
            className="flex items-center text-2xl hover:cursor-pointer hover:text-[#fff]"
            onClick={() => setDropDown(!dropDown)}
          >
            <img
              src={IconArrowDown}
              alt="Icon Arrow Down"
              className={`w-9 ${dropDown ? "rotate-180" : ""} duration-200`}
            />
            Portfolio
          </span>
          <AnimatePresence>
